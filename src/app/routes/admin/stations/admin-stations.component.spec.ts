...
describe('StationsComponent', () => {
  ...
  it('should sort mat table', () => {
    component.msSortData({active: 'fullName', direction: 'asc'}, 'msSort');
    component.msSortData({active: 'fullName', direction: 'asc'}, 'rsSort');
    component.msSortData({active: '', direction: ''}, 'rsSort');
    component.msSortData({active: '', direction: ''}, 'msSort');
    expect(component.msSortData).toBeDefined();
  });

  it('should get tab name', () => {
    component.getTabName('');
    expect(component.getTabName).toBeDefined();
  });
