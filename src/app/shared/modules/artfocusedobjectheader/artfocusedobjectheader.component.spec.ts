...
describe('ArtfocusedobjectheaderComponent', () => {
  ...
  it('isDropdownItemActive should create', () => {
    component.isFocussedDropdownItemActive([]);
    expect(component.isFocussedDropdownItemActive([])).toBeDefined();
  });
  it('should defined isActive event', () => {
    component.isFocussedActive([]);
    expect(component.isFocussedActive).toBeDefined();
  });
});
