...
describe('FlightService', () => {
    ...
    it(
        ...
        inject(
            ...
            (httpMock: HttpTestingController, flightService: FlightService) => {
              flightService.getFlightList(1, '2019-11-10T00:00:00Z', '2019-11-10T00:00:00Z', '', true).subscribe(() => {
    ...
    it(
      ...
      inject(
          [HttpTestingController, FlightService],
          (httpMock: HttpTestingController, flightService: FlightService) => {
            flightService.getFlightList(1, '2019-11-10T00:00:00Z', '2019-11-10T00:00:00Z', 'N101NN', true).subscribe(() => {
                  const mockReq = httpMock.expectOne('http://example.com');
